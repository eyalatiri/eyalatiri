...
Data Science Engineering student at ESPRIT (2022–2027), specializing in LLM systems, AI agents, and multimodal AI. I build things that bridge research and production — from multi-agent pipelines to clinical decision support systems.

**What I work with**
- **LLM & agents:** LangGraph, RAG pipelines, FAISS, prompt engineering, QLoRA
- **ML & DL:** PyTorch, scikit-learn, encoder-decoder architectures, visual attention, LSTM/CNN
- **Backend & infra:** FastAPI, Flask, .NET, React.js
...
**Currently**
- 🎓 4th year at ESPRIT (graduation 2027)
- 📍 Tunis, Tunisia
- 📬 eya.latiri@gmail.com

[![LinkedIn](https://img.shields.io/badge/LinkedIn-latiri--eya-blue?style=flat&logo=linkedin)](https://linkedin.com/in/latiri-eya-6ba97a292)
